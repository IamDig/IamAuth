    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] args) {
        if (commandSender instanceof Player) {
            ...
            if (modifyFile.getString(sender.getUniqueId() + " password") != null) {
                ...
                } else for (String msg : main.getConfig().getStringList("already-logged-message")) sender.sendMessage(ChatColor.translateAlternateColorCodes('&', msg));
            } else for (String msg : main.getConfig().getStringList("register-auth-message")) sender.sendMessage(ChatColor.translateAlternateColorCodes('&', msg));
        }
        return false;
    }
}
