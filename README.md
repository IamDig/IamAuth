...
- ```Automatic login for Premium Accounts```: The plugin includes a system that checks if a player is premium and if so, makes him automatically log in, otherwise he will have to manually log in again.
